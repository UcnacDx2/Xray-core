...
func (x *DesyncConfig) GetSendPayload() bool {
	if x != nil {
...
type SocketConfig struct {
	...
	Desync                     *DesyncConfig        `protobuf:"bytes,24,opt,name=desync,proto3" json:"desync,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *SocketConfig) GetDesync() *DesyncConfig {
	if x != nil {
		return x.Desync
	}
	return nil
...
type DesyncConfig struct {
	...
	SendPayload   bool                   `protobuf:"varint,5,opt,name=send_payload,json=sendPayload,proto3" json:"send_payload,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DesyncConfig) Reset() {
	*x = DesyncConfig{}
...
func (x *DesyncConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DesyncConfig) ProtoMessage() {}

func (x *DesyncConfig) ProtoReflect() protoreflect.Message {
	mi := &file_transport_internet_config_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DesyncConfig.ProtoReflect.Descriptor instead.
func (*DesyncConfig) Descriptor() ([]byte, []int) {
	return file_transport_internet_config_proto_rawDescGZIP(), []int{5}
}

func (x *DesyncConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *DesyncConfig) GetTtl() int32 {
	if x != nil {
		return x.Ttl
	}
	return 0
...
func (x *DesyncConfig) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
const file_transport_internet_config_proto_rawDesc = "" +
	...
	"\x04type\x18\x06 \x01(\tR\x04type\"\xc8\t\n" +
	...
	"\x06desync\x18\x18 \x01(\v2%.xray.transport.internet.DesyncConfigR\x06desync\"/\n" +
	"\n" +
	"TProxyMode\x12\a\n" +
	"\x03Off\x10\x00\x12\n" +
	"\n" +
...
var file_transport_internet_config_proto_goTypes = []any{
	...
	(*DesyncConfig)(nil),         // 8: xray.transport.internet.DesyncConfig
...
var file_transport_internet_config_proto_depIdxs = []int32{
	...
	9,  // 9: xray.transport.internet.SocketConfig.happy_eyeballs:type_name -> xray.transport.internet.HappyEyeballsConfig
	8,  // 10: xray.transport.internet.SocketConfig.desync:type_name -> xray.transport.internet.DesyncConfig
